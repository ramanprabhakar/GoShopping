...
public class HttpService {
    ...
    public void getHomePage1(String q, List<String> flList, String rows, String wt, Callback<ServerResponse> callback) {
        restService.getHomePage1(q, flList, rows, wt, callback);
    }


    public void getHomePage2(String q, List<String> flList, String rows, String start, String wt, Callback<ServerResponse> callback) {
        restService.getHomePage2(q, flList, rows, start, wt, callback);
    }

    public void getFilter1(String q, String fq, List<String> flList, String rows, String wt, Callback<ServerResponse> callback) {
        restService.getFilter1(q, fq, flList, rows, wt, callback);
    }

    public void getFilter2(String q, String fq, List<String> flList, String rows, String start, String wt, Callback<ServerResponse> callback) {
        restService.getFilter2(q, fq, flList, rows, start, wt, callback);
    }

    public void getDetails(String q, String token, List<String> flList, String rows, String wt, Callback<ServerResponse> callback) {
